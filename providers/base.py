...
def _profile_user_agent() -> str:
    """Return a ``aot-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from aot_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"aot-cli/{_ver}"
    except Exception:
        return "aot-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # aot-cli UA so the catalog endpoint is reachable.
