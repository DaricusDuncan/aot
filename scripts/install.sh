...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/DaricusDuncan/aot/main/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:DaricusDuncan/aot.git"
REPO_URL_HTTPS="https://github.com/DaricusDuncan/aot.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/DaricusDuncan/aot/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
