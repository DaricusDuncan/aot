...
DEFAULT_DATASETS = [
    ...
    "NousResearch/aot-agent-megascience-sft1",
    "NousResearch/Aot-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Aot-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-aot-agent"
]
