#!/usr/bin/env python3
"""Build the Aot Skills Index — a centralized JSON catalog of all skills.
...
`aot skills search/install` can use it without hitting the GitHub API.
...
# Ensure AOT_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Aot Skills Index...", flush=True)
