...
Built for [Aot Agent](https://github.com/NousResearch/aot-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/aot-agent/skills/creative/ascii-video`](https://github.com/NousResearch/aot-agent/tree/main/skills/creative/ascii-video) via PR.
