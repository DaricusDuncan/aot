...
Config: ~/.aot/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.aot/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_aot_home()`` helper (AOT_HOME-aware and
...
RULES_FILE = get_aot_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_aot_home() / "feishu_comment_pairing.json"
