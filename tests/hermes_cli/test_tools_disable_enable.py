"""Tests for aot tools disable/enable/list command (backend)."""
...
class TestToolsDisableBuiltin:
    ...
    def test_disable_removes_toolset_from_platform(self):
        ...
        with patch("aot_cli.tools_config.load_config", return_value=config), \
             patch("aot_cli.tools_config.save_config") as mock_save:
