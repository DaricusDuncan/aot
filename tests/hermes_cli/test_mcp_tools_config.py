"""Tests for MCP tools interactive configuration in aot_cli.tools_config."""

from types import SimpleNamespace
from unittest.mock import MagicMock, patch

from aot_cli.tools_config import _configure_mcp_tools_interactive

# Patch targets: imports happen inside the function body, so patch at source
_PROBE = "tools.mcp_tool.probe_mcp_server_tools"
_CHECKLIST = "aot_cli.curses_ui.curses_checklist"
_SAVE = "aot_cli.tools_config.save_config"
