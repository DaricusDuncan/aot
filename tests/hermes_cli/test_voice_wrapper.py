"""Tests for ``aot_cli.voice`` — the TUI gateway's voice wrapper.
...
class TestNormalizeVoiceRecordKeyForPromptToolkit:
    ...
    def test_ctrl_and_alt_map_to_prompt_toolkit_form(self):
        from aot_cli.voice import normalize_voice_record_key_for_prompt_toolkit
    ...
    # parser rejects alt+c/d/l because aot-ink reports Alt as
...
class TestVoiceRecordKeyFromConfig:
    ...
    def test_dict_voice_with_string_record_key(self):
        from aot_cli.voice import voice_record_key_from_config
