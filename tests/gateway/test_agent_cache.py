...
class TestAgentConfigSignature:
    ...
    def test_same_config_same_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["aot-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["aot-telegram"], "")
        assert sig1 == sig2
    ...
    def test_model_change_different_signature(self):
        ...
        runtime = {"api_key": "sk-test12345678", "base_url": "https://openrouter.ai/api/v1",
                    "provider": "openrouter"}
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["aot-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-opus-4.6", runtime, ["aot-telegram"], "")
        assert sig1 != sig2
    ...
    def test_same_token_prefix_different_full_token_changes_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt1, ["aot-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("gpt-5.3-codex", rt2, ["aot-telegram"], "")
        assert sig1 != sig2
    ...
    def test_provider_change_different_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt1, ["aot-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", rt2, ["aot-telegram"], "")
        assert sig1 != sig2
    ...
    def test_toolset_change_different_signature(self):
        ...
        sig1 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["aot-telegram"], "")
        sig2 = GatewayRunner._agent_config_signature("claude-sonnet-4", runtime, ["aot-discord"], "")
        assert sig1 != sig2
...
class TestAgentCacheLifecycle:
    ...
    def test_cache_hit_returns_same_agent(self):
        ...
        runtime = {"api_key": "test", "base_url": "https://openrouter.ai/api/v1",
                    "provider": "openrouter", "api_mode": "chat_completions"}
        sig = runner._agent_config_signature("anthropic/claude-sonnet-4", runtime, ["aot-telegram"], "")
    ...
    def test_cache_miss_on_model_change(self):
        ...
        old_sig = runner._agent_config_signature("anthropic/claude-sonnet-4", runtime, ["aot-telegram"], "")
        agent1 = AIAgent(
            model="anthropic/claude-sonnet-4", api_key="test",
            base_url="https://openrouter.ai/api/v1", provider="openrouter",
            max_iterations=5, quiet_mode=True, skip_context_files=True,
        ...
        new_sig = runner._agent_config_signature("anthropic/claude-opus-4.6", runtime, ["aot-telegram"], "")
