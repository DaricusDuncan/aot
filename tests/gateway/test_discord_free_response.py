...
class FakeTextChannel:
    def __init__(self, channel_id: int = 1, name: str = "general", guild_name: str = "Aot Server"):
        self.id = channel_id
        self.name = name
...
class FakeForumChannel:
    def __init__(self, channel_id: int = 1, name: str = "support-forum", guild_name: str = "Aot Server"):
        self.id = channel_id
        self.name = name
        self.guild = SimpleNamespace(name=guild_name)
        self.type = 15
...
class FakeThread:
    def __init__(self, channel_id: int = 1, name: str = "thread", parent=None, guild_name: str = "Aot Server"):
        self.id = channel_id
        self.name = name
        self.parent = parent
...
async def test_discord_forum_threads_are_handled_as_threads(adapter, monkeypatch):
    ...
    thread = FakeThread(channel_id=456, name="Can Aot reply here?", parent=forum)
    ...
    assert event.source.thread_id == "456"
    assert event.source.chat_type == "thread"
    assert event.source.chat_name == "Aot Server / support-forum / Can Aot reply here?"
