...
class TestBlockingApprovalE2E:
    ...
    def setup_method(self):
        ...
        os.environ.pop("AOT_GATEWAY_SESSION", None)
        os.environ.pop("AOT_EXEC_ASK", None)
        os.environ.pop("AOT_SESSION_KEY", None)
    ...
    def test_blocking_approval_approve_once(self):
        ...
        def agent_thread():
            ...
            os.environ["AOT_SESSION_KEY"] = session_key
            try:
...
class TestFallbackNoCallback:
    ...
    def test_no_callback_returns_approval_required(self):
        ...
        os.environ["AOT_EXEC_ASK"] = "1"
        os.environ["AOT_SESSION_KEY"] = "no-callback-test"
        try:
