...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.aot/aot-agent/.worktrees/aot-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
async def test_run_agent_progress_stays_in_originating_topic(monkeypatch, tmp_path):
    monkeypatch.setenv("AOT_TOOL_PROGRESS_MODE", "all")
