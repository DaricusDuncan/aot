...
def worker_loop(worker_id: int, aot_home: str, result_file: str) -> None:
...
def reclaimer_loop(aot_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="aot_mixed_stress_")
    print(f"AOT_HOME = {home}")
