...
class TestVerifierEnabled:
    def test_default_is_enabled(self, monkeypatch):
        monkeypatch.delenv("AOT_FILE_MUTATION_VERIFIER", raising=False)
        agent = _bare_agent()
