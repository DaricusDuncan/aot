...
def _enable_managed_nous_tools(monkeypatch):
    ...
    aot_cli.auth and aot_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("aot_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("aot_cli.models.check_nous_free_tier", lambda: False)
