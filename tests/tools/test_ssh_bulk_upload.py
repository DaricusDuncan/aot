...
class TestSSHBulkUpload:
    ...
    def test_mkdir_batched_into_single_call(self, mock_env, tmp_path):
        ...
        files = [
            (str(f1), "/home/testuser/.aot/skills/a.txt"),
            (str(f2), "/home/testuser/.aot/credentials/b.txt"),
        ]
        ...
        assert "/home/testuser/.aot/skills" in mkdir_str
        assert "/home/testuser/.aot/credentials" in mkdir_str
    ...
    def test_staging_symlinks_mirror_remote_layout(self, mock_env, tmp_path):
        ...
        files = [
            (str(f1), "/home/testuser/.aot/skills/my_skill.md"),
        ]
        ...
        def capture_tar_cmd(cmd, **kwargs):
            if cmd[0] == "tar":
                ...
                expected = os.path.join(
                    staging_dir, "home/testuser/.aot/skills/my_skill.md"
                )
    ...
    def test_tar_pipe_commands(self, mock_env, tmp_path):
        ...
        files = [(str(f1), "/home/testuser/.aot/cache/x.txt")]
    ...
    def test_mkdir_failure_raises(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "y.txt"
        f1.write_text("y")
        files = [(str(f1), "/home/testuser/.aot/skills/y.txt")]
    ...
    def test_tar_create_failure_raises(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "z.txt"
        f1.write_text("z")
        files = [(str(f1), "/home/testuser/.aot/skills/z.txt")]
    ...
    def test_ssh_extract_failure_raises(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "w.txt"
        f1.write_text("w")
        files = [(str(f1), "/home/testuser/.aot/skills/w.txt")]
    ...
    def test_ssh_command_uses_control_socket(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "c.txt"
        f1.write_text("c")
        files = [(str(f1), "/home/testuser/.aot/cache/c.txt")]
    ...
    def test_custom_port_and_key_in_ssh_command(self, monkeypatch, tmp_path):
        ...
        f1 = tmp_path / "d.txt"
        f1.write_text("d")
        files = [(str(f1), "/home/u/.aot/skills/d.txt")]
    ...
    def test_parent_dirs_deduplicated(self, mock_env, tmp_path):
        ...
        files = [
            (str(f1), "/home/testuser/.aot/skills/a.txt"),
            (str(f2), "/home/testuser/.aot/skills/b.txt"),
            (str(f3), "/home/testuser/.aot/credentials/c.txt"),
        ]
        ...
        assert mkdir_str.count("/home/testuser/.aot/skills") == 1
        assert "/home/testuser/.aot/credentials" in mkdir_str
    ...
    def test_tar_stdout_closed_for_sigpipe(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "s.txt"
        f1.write_text("s")
        files = [(str(f1), "/home/testuser/.aot/skills/s.txt")]
    ...
    def test_timeout_kills_both_processes(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "t.txt"
        f1.write_text("t")
        files = [(str(f1), "/home/testuser/.aot/skills/t.txt")]
...
class TestSSHBulkUploadEdgeCases:
    ...
    def test_ssh_popen_failure_kills_tar(self, mock_env, tmp_path):
        ...
        f1 = tmp_path / "e.txt"
        f1.write_text("e")
        files = [(str(f1), "/home/testuser/.aot/skills/e.txt")]
