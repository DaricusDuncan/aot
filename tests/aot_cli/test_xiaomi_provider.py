...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from aot_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in AOT_OVERLAYS
        overlay = AOT_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify aot doctor recognizes Xiaomi env vars."""
