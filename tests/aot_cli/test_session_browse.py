"""Tests for the interactive session browser (`aot sessions browse`).
...
from aot_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """aot sessions browse should be parseable."""
        from aot_cli.main import main as _main_entry
