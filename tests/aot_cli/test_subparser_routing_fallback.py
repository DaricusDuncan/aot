...
The main() function in aot_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `aot -c model`
...
def _build_parser():
    """Build a minimal replica of the aot top-level parser."""
