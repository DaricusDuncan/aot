...
import os
import pytest
from aot_cli.config import _expand_env_vars, load_config
...
class TestLoadConfigExpansion:
    def test_load_config_expands_env_vars(self, tmp_path, monkeypatch):
        ...
        # aot_cli.config, making string-target monkeypatches hit a different
...
class TestLoadCliConfigExpansion:
    ...
    def test_cli_config_expands_auxiliary_api_key(self, tmp_path, monkeypatch):
        ...
        # Patch the aot home so load_cli_config finds our test config
