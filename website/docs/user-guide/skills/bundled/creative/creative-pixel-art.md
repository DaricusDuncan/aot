...
```python
import sys
sys.path.insert(0, "/home/teknium/.aot/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.aot/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Aot installs package this)
