...
Control the user's Spotify account via the Aot Spotify toolset (7 tools). Setup guide: https://aot-agent.nousresearch.com/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `aot auth spotify` again.
