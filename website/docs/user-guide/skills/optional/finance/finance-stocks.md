...
| | |
|---|---|
| Source | Optional — install with `aot skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Aot Agent |
| License | MIT |
...
```
SCRIPT=~/.aot/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.aot/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
