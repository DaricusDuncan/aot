...
| | |
|---|---|
| Source | Optional — install with `aot skills install official/health/neuroskill-bci` |
...
Connect Aot to a running [NeuroSkill](https://neuroskill.com/) instance to read
