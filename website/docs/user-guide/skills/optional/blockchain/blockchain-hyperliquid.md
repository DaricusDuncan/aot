...
| | |
|---|---|
| Source | Optional — install with `aot skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Aot Agent |
| License | MIT |
...
The script reads `~/.aot/.env` for two optional defaults:
...
Helper script: `~/.aot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.aot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.aot/.env`.
...
```bash
python3 ~/.aot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.aot/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
