...
| | |
|---|---|
| Source | Optional — install with `aot skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Aot Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $AOT_OSINT_CACHE/icij/ (default: ~/.cache/aot-osint/icij/).
...
# Set AOT_OSINT_UA=your-app/1.0 (your@email) to identify yourself
