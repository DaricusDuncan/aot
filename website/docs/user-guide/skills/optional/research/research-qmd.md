...
| | |
|---|---|
| Source | Optional — install with `aot skills install official/research/qmd` |
...
Aot Agent via the native MCP client. This is the preferred
...
Then configure Aot Agent to connect via HTTP:
