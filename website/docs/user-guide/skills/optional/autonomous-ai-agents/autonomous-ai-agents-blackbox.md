...
| | |
|---|---|
| Source | Optional — install with `aot skills install official/autonomous-ai-agents/blackbox` |
...
| Related skills | [`claude-code`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-claude-code), [`codex`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-codex), [`aot-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-aot-agent) |
...
Delegate coding tasks to [Blackbox AI](https://www.blackbox.ai/) via the Aot terminal. Blackbox is a multi-model coding agent CLI that dispatches tasks to multiple LLMs (Claude, Codex, Gemini, Blackbox Pro) and uses a judge to select the best implementation.
