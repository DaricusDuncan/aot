#!/usr/bin/env python3
"""
SWE Runner with Aot Trajectory Format

A runner that uses Aot-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Aot-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Aot-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Aot format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Aot-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Aot-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Aot Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Aot-Agent's built-in execution environments
    and outputs trajectories in Aot-Agent format.
    """
    ...
    def _convert_to_aot_format(
        ...
        """
        Convert internal message format to Aot trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Aot trajectory format
        trajectory = self._convert_to_aot_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Aot trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Aot Trajectory Format")
    print("=" * 60)
