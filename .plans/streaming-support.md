# Streaming LLM Response Support for Aot Agent
...
```
AOT_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("AOT_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `aot_cli/config.py` | 1 | +streaming config defaults |
