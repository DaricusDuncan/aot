...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateAot: "Update Aot",
    updatingAot: "Updating Aot…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Aot plugins (`aot plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.aot/plugins/?",
    removeHint: "Only user-installed plugins under ~/.aot/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.aot/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Aot badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Aot session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Aot more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Aot sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Aot is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
