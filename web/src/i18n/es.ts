...
export const es: Translations = {
  ...
  status: {
    ...
    stopped: "Detenido",
    updateAot: "Actualizar Aot",
    updatingAot: "Actualizando Aot…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descubre, instala, habilita y actualiza complementos de Aot (equivalente a `aot plugins`).",
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.aot/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.aot/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.aot/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Insignias coleccionables de Aot ganadas a partir del historial real de sesiones. Los logros conocidos no completados se muestran como Descubiertos; los logros secretos permanecen ocultos hasta que aparece el primer comportamiento coincidente.",
      scan_subtitle:
        "Escaneando el historial de sesiones de Aot. El primer escaneo puede tardar 5–10 segundos en historiales grandes.",
    },
    actions: {
    ...
    guide: {
      ...
      secret_body:
        "Los secretos ocultan su disparador exacto. Una vez que Aot detecta una señal relacionada, la tarjeta pasa a Descubierto y muestra su requisito.",
      scan_status_header: "Estado del escaneo",
      scan_status_body:
        "Aot está escaneando el historial local una vez, después las tarjetas aparecerán automáticamente. No hay nada bloqueado si tarda unos segundos.",
