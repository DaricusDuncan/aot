...
export const hu: Translations = {
  ...
  status: {
    ...
    stopped: "Leállítva",
    updateAot: "Aot frissítése",
    updatingAot: "Aot frissítése…",
  ...
  pluginsPage: {
    ...
    headline:
      "Aot-bővítmények felfedezése, telepítése, engedélyezése és frissítése (a `aot plugins` paritás).",
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.aot/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.aot/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.aot/skills/ mappából töltődnek be",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Gyűjthető Aot-jelvények, valós munkamenet-előzmények alapján szerezve. Az ismert, de még nem szerzett teljesítmények Felfedezettként jelennek meg; a Titkos teljesítmények rejtve maradnak az első egyező viselkedésig.",
      scan_subtitle:
        "Aot munkamenet-előzmények vizsgálata. Az első vizsgálat 5–10 másodpercig is eltarthat nagy előzmények esetén.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Legutóbbi",
      latest_hint_empty: "futtasd többet a Aott",
      none_yet: "Még semmi",
    },
    state: {
      unlocked: "Feloldva",
    ...
    guide: {
      ...
      secret_body:
        "A titkos teljesítmények elrejtik a pontos kiváltó eseményt. Amint a Aot kapcsolódó jelet észlel, a kártya Felfedezettre vált, és megjeleníti a követelményt.",
      scan_status_header: "Vizsgálat állapota",
      scan_status_body:
        "A Aot egyszer átvizsgálja a helyi előzményeket, majd a kártyák automatikusan megjelennek. Semmi sem akadt el, ha ez néhány másodpercig tart.",
