...
export const ga: Translations = {
  ...
  status: {
    ...
    stopped: "Stoptha",
    updateAot: "Nuashonraigh Aot",
    updatingAot: "Ag nuashonrú Aot…",
  ...
  pluginsPage: {
    ...
    headline:
      "Faigh, suiteáil, cumasaigh agus nuashonraigh plugins Aot (paireacht le `aot plugins`).",
    ...
    removeConfirm: "Bain an plugin seo ó ~/.aot/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.aot/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.aot/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Suaitheantais Aot inbhailithe a thuilltear ó stair fíor-session. Léirítear gnóthachtálacha aitheanta neamhchríochnaithe mar Discovered; fanann gnóthachtálacha Secret i bhfolach go dtí go bhfeictear an chéad iompar comhoiriúnach.",
      scan_subtitle:
        "Stair session Aot á scanadh. Is féidir leis an gcéad scan 5–10 soicind a thógáil ar staireanna móra.",
    },
    actions: {
      rescan: "Athscan",
    },
    stats: {
      ...
      latest_hint_empty: "rith Aot níos mó",
    ...
    guide: {
      ...
      secret_body:
        "Coinníonn rúin a dtruicear cruinn faoi cheilt. Nuair a fheiceann Aot comhartha gaolmhar, athraíonn an cárta go Aimsithe agus taispeánann sé a riachtanas.",
      scan_status_header: "Stádas an scanta",
      scan_status_body:
        "Scanann Aot an stair logánta uair amháin, ansin feicfear cártaí go huathoibríoch. Níl aon rud sáinnithe má thógann sé cúpla soicind.",
