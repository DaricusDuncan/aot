...
export const pt: Translations = {
  ...
  status: {
    ...
    stopped: "Parado",
    updateAot: "Atualizar Aot",
    updatingAot: "A atualizar Aot…",
  ...
  pluginsPage: {
    ...
    headline:
      "Descobrir, instalar, ativar e atualizar plugins Aot (paridade com `aot plugins`).",
    ...
    removeConfirm: "Remover este plugin de ~/.aot/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.aot/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.aot/skills/",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Distintivos colecionáveis do Aot obtidos a partir do histórico real de sessões. Conquistas conhecidas mas ainda não obtidas aparecem como Descobertas; conquistas Secretas permanecem ocultas até surgir o primeiro comportamento correspondente.",
      scan_subtitle:
        "A analisar o histórico de sessões do Aot. A primeira análise pode demorar 5–10 segundos em históricos extensos.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Mais recente",
      latest_hint_empty: "execute mais o Aot",
    ...
    guide: {
      ...
      secret_body:
        "As secretas escondem o seu acionador exato. Assim que o Aot detetar um sinal relacionado, o cartão passa a Descoberta e mostra o requisito.",
      scan_status_header: "Estado da análise",
      scan_status_body:
        "O Aot analisa o histórico local uma vez e depois os cartões aparecem automaticamente. Nada está bloqueado se isto demorar alguns segundos.",
