...
export const fr: Translations = {
  ...
  status: {
    ...
    stopped: "Arrêté",
    updateAot: "Mettre à jour Aot",
    updatingAot: "Mise à jour de Aot…",
  ...
  pluginsPage: {
    ...
    headline:
      "Découvrez, installez, activez et mettez à jour les plugins Aot (parité avec `aot plugins`).",
    ...
    removeConfirm: "Retirer ce plugin de ~/.aot/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.aot/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.aot/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "Aot Achievements",
      subtitle:
        "Badges Aot à collectionner, gagnés à partir de l'historique réel des sessions. Les succès connus non terminés sont affichés comme Découverts ; les succès secrets restent cachés jusqu'à l'apparition du premier comportement correspondant.",
      scan_subtitle:
        "Analyse de l'historique des sessions Aot en cours. Le premier scan peut prendre 5 à 10 secondes sur les historiques volumineux.",
    },
    actions: {
    ...
    stats: {
      ...
      latest: "Dernier",
      latest_hint_empty: "utilisez Aot davantage",
    ...
    guide: {
      ...
      secret_body:
        "Les secrets cachent leur déclencheur exact. Dès qu'Aot détecte un signal lié, la carte passe à Découvert et affiche son exigence.",
      scan_status_header: "État du scan",
      scan_status_body:
        "Aot analyse l'historique local une seule fois, puis les cartes apparaîtront automatiquement. Rien n'est bloqué si cela prend quelques secondes.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Aot Agent ☤",
    },
  },
  kanban: {
