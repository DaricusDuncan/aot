...
const STORAGE_KEY = "aot-dashboard-theme";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `aot_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "aot-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-aot-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-aot-theme-font", "true");
