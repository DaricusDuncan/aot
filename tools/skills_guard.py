...
Trust levels:
  - builtin:   Ships with Aot. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.aot/\.env|\~/\.aot/\.env',
     "aot_env_access", "critical", "exfiltration",
     "directly references Aot secrets file"),
    ...
    (r'\.aot/config\.yaml|\.aot/SOUL\.md',
     "aot_config_mod", "critical", "persistence",
     "references Aot configuration files directly"),
