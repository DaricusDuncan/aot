...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/aot-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/aot-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/aot-results"
HEREDOC_MARKER = "AOT_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"AOT_PERSIST_{uuid.uuid4().hex[:8]}"
