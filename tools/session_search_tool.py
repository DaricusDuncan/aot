...
the get_anchored_view / get_messages_around primitives in aot_state.
...
# Third-party integrations tag their sessions with AOT_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from aot_state import DEFAULT_DB_PATH
