...
Used by ``aot profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``aot_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Aot Agent kanban board.
...
Rules:
  ...
  - Never write "Aot Agent profile" or other meta-narration.
