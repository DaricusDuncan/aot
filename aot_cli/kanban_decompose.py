...
Invoked by ``aot kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Aot Agent board.
...
def _profile_author() -> str:
    """Mirror of ``aot_cli.kanban._profile_author``."""
    return (
