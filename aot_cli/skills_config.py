"""
Skills configuration for Aot Agent.
`aot skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.aot/config.yaml under:
...
from aot_cli.config import cfg_get, load_config, save_config
from aot_cli.colors import Colors, color
from aot_cli.platforms import PLATFORMS as _PLATFORMS
