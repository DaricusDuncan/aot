...
Data file: $AOT_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_AOT_HOME = Path(os.environ.get("AOT_HOME", Path.home() / ".aot"))
DATA_DIR = _AOT_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
