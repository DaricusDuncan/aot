# Aot Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.aot/plugins/aot-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.aot/plugins/aot-achievements/scan_checkpoint.json`.
