...
import type { ScrollBoxHandle } from '@aot/ink'
import { evictInkCaches } from '@aot/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.AOT_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
